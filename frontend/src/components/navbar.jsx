    ...
    return (
        <div className='w-full absolute top-0 left-0 z-10'>
            <div className='container mx-auto flex justify-between items-center py-4 px-20 md:px-20 lg-px-32'>
                <img src={assets.logo} alt="" className='w-30 bg-black rounded-[15px] py-2 px-2 transition duration-250 ease-in-out hover:scale-110'/>
                <ul className='hidden md:flex gap-8 text-[20px] text-black'>
                ...
                <button className='hidden md:block text-white py-2 px-6 bg-black rounded-[15px] transition duration-250 ease-in-out hover:scale-110'>Sign up</button>
            </div>
        </div>
