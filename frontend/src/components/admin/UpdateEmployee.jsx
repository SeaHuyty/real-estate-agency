...
const CreateEmployee = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        let imageUrl = formData.profile; // returns secure_url
        if (file) {
            try {
                        ...
                        <div className='w-150 border border-gray-300 rounded-lg p-5'>
                            ...
                            <div className='mt-10 grid grid-cols-2 gap-5'>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="number" id="phoneNumber" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" 
