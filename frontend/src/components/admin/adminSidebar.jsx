        ...
        <div className="flex">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="text-sm text-gray-300">We are cooked</p>
                    <button 
                        onClick={handleLogout} 
                        className="mt-4 flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
                ...
                {/* Navigation */}
                {/* <span className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-blue-800 transition-colors">
                    ...
                    <span class=" flex-1 text-white ms-3 whitespace-nowrap"></span>
                </span> */}
                <nav className="flex flex-col space-y-2 text-sm font-medium​​ mt-2">
                    <div className="text-sm space-y-1 text-gray-300 border border-gray-500 rounded-lg p-2">
                        <Link to="/hr" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-white hover:bg-blue-800 transition-colors px-4 py-3">
                        ...
                        <Link to="/hr/createEmployee" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-white hover:bg-blue-800 transition-colors px-4 py-3">
