            ...
            >
                ...
                <nav className="flex flex-col space-y-2 text-sm font-medium​​ mt-2">
                    <div className="text-sm space-y-1 text-gray-300 border border-gray-500 rounded-lg p-2">
                        ...
                        <Link to="/admin/register" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-white hover:bg-blue-800 transition-colors px-4 py-3">
                            ...
                            <span class=" flex-1 text-white ms-3 whitespace-nowrap">Create Admin</span>
                        </Link>
